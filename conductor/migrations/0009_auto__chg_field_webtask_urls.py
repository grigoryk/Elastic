...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebTask.urls'
        db.alter_column('conductor_webtask', 'urls', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'WebTask.urls'
        db.alter_column('conductor_webtask', 'urls', self.gf('django.db.models.fields.TextField')(default=''))
